                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                Image.asset('assets/images/onion.png', height: 100),
                                const SizedBox(height: 10),
                                const Text('Onion', style: TextStyle(fontWeight: FontWeight.bold)),
                                const Text('Organic', style: TextStyle(fontSize: 12)),
                                const SizedBox(height: 5),
                                Row(
                                  children: const [
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                Image.asset('assets/images/tomato.png', height: 100),
                                const SizedBox(height: 10),
                                const Text('Tomato', style: TextStyle(fontWeight: FontWeight.bold)),
                                const Text('Organic', style: TextStyle(fontSize: 12)),
                                const SizedBox(height: 5),
                                Row(
                                  children: const [
